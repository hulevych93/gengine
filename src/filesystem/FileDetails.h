...
public:
    FileDetails(boost::filesystem::wpath const& modulePath, std::time_t const& lastWriteTime, int level) 
    ...
    std::time_t const& LastWriteTime() const
    {
        return m_LastWriteTime;
    }
    
    boost::filesystem::wpath const& FilePath() const
    {
        return m_FilePath;
    }
...
private:
    static boost::filesystem::wpath make_relative( boost::filesystem::wpath const& path, int level )
    {
        try
        {
