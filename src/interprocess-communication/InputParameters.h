...
private:
    ...
    bool Get(std::int8_t index, void** data, std::uint32_t* size, ParametersTypes type) const;

    template<class T>
    bool GetContainer(std::int8_t index, T& container, ParametersTypes containerType) const
    {
