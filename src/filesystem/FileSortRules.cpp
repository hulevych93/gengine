...
int SortByLevel::operator()(SearchResult_t::value_type const& lhs,
...
int SortByFileName::operator()(SearchResult_t::value_type const& lhs,
                               SearchResult_t::value_type const& rhs) const {
  return rhs->FileName().compare(lhs->FileName());
}

int SortByTime::operator()(SearchResult_t::value_type const& lhs,
                           SearchResult_t::value_type const& rhs) const {
