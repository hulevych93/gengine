...
namespace std {
template<class T, class V> struct hash<std::pair<T, V>> {
...
template<class T, class V> struct hash<std::map<T, V>> {
...
template<class T, class V> struct hash<std::unordered_map<T, V>> {
...
template<class T> struct hash<boost::optional<T>> {
...
template<class... T> struct hash<boost::variant<T...>> {
