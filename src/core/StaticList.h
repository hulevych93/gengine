...
public:
    ...
    void Register()
    {
        _Do(&Action::Do, false, true);
    }
    
    void Unregister()
    {
        _Do(&Action::Undo, true, false);
    }
...
public:
    static void Do()
    {
        _Do(&_Fi_t::Register, false, true);
    }

    static void Undo()
    {
        _Do(&_Fi_t::Unregister, true, false);
    }
...
private:
    ...
    static _Fl_t& _Fl()
    {
        return _Fl_t::Instance();
    }
};

} /// end namespace _AutoReg
